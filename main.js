...
houseWindow.position.set(2.01,1.5,-0.2)
houseWindow.rotation.y=1.6
...
const walls= new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        emissive: new THREE.Color(0x8B4513), // A warm brown to enhance brick color
...
house.add(door)
// bushes
const  bushGeometery= new THREE.SphereGeometry(1,16,16)
const bushMaterial= new THREE.MeshStandardMaterial({color:"#89c854"})

const createBush = (scale, position) => {
    const bush = new THREE.Mesh(bushGeometery, bushMaterial);
  ...
  const bushes = [
    ...
    createBush([0.25, 0.25, 0.25], [-0.8, 0.1, 2.6]),
  ];
...
const floor = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        emissive: new THREE.Color(0x228B22), // Forest green, adjust as needed
        emissiveIntensity: 0.2
...
// doorlight
const doorLight= new THREE.PointLight("#ff7df6" ,4,6)
...
const tick = () =>
{
    ...
    ghost1.position.y=Math.sin(elapsedTime*0.5)
